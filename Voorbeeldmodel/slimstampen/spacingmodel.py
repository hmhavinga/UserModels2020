...
# Added boolean 'hint' to Response
# TODO: change this in the jupyter notebook.
...
class SpacingModel(object):
    ...
    def normalise_reaction_time(self, response):
        ...
        """
        # Added extra time when getting a hint
        rt = response.rt if (response.correct and not response.hint) else 1.25*response.rt if response.correct else 60000
